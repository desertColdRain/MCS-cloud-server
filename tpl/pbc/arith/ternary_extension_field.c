...
static void gf3m_random(element_t a) {
    ...
    // pbc_error("ternary_extension_field.c gf3m_random start: \n");
    params *c = PARAM(a);
    unsigned rm = c->m % W;
...
static void gf32m_random(element_t e) {
  // pbc_error("ternary_extension_field.c gf32m_random start: \n");
    element_ptr e0 = GF32M(e)->_0, e1 = GF32M(e)->_1;
    element_random(e0);
    element_random(e1);
    // pbc_error("ternary_extension_field.c gf32m_random end: \n");
}
...
static void gf33m_random(element_t e) {
    // pbc_error("ternary_extension_field.c gf33m_random start: \n");
    element_ptr e0 = GF33M(e)->_0, e1 = GF33M(e)->_1, e2 = GF33M(e)->_2;
    element_random(e0);
    element_random(e1);
    element_random(e2);
    // pbc_error("ternary_extension_field.c gf33m_random end: \n");
}
